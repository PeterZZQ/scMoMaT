...
dir <- "../data/simulated/6b16c_test_10/imbalanced/"
results_dir <- "simulated/6b16c_test_10/imbalanced/uinmf/"
...
liger_bin <- rliger::createLiger(list(peak1 = counts.atac.1, peak2 = counts.atac.2, peak3 = counts.atac.3, peak4 = counts.atac.4), remove.missing = FALSE)
...
ifnb_liger <- rliger::createLiger(list(rna1 = activity.matrix.1, rna2 = activity.matrix.2, rna3 = activity.matrix.3, rna4 = counts.rna.4, rna5 = counts.rna.5, rna6 = counts.rna.6), remove.missing = FALSE)
