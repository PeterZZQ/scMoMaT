...
# read in the dataset
GxC1 <- readMM("../data/real/ASAP-PBMC/GxC1.mtx") 
GxC2 <- readMM("../data/real/ASAP-PBMC/GxC2.mtx") 
PxC1 <- readMM("../data/real/ASAP-PBMC/PxC1.mtx") 
PxC2 <- readMM("../data/real/ASAP-PBMC/PxC2.mtx") 
PxC3 <- readMM("../data/real/ASAP-PBMC/PxC3.mtx") 
PxC4 <- readMM("../data/real/ASAP-PBMC/PxC4.mtx") 
RxC3 <- readMM("../data/real/ASAP-PBMC/RxC3.mtx") 
RxC4 <- readMM("../data/real/ASAP-PBMC/RxC4.mtx")
# features
genes <- read.csv("../data/real/ASAP-PBMC/genes.txt", header = FALSE)
regions <- read.csv("../data/real/ASAP-PBMC/regions.txt", header = FALSE)
proteins <- read.csv("../data/real/ASAP-PBMC/proteins.txt", header = FALSE)
# meta_data
meta_1 <- read.csv("../data/real/ASAP-PBMC/meta_c1.csv", row.names = 1)
meta_2 <- read.csv("../data/real/ASAP-PBMC/meta_c2.csv", row.names = 1)
meta_3 <- read.csv("../data/real/ASAP-PBMC/meta_c3.csv", row.names = 1)
meta_4 <- read.csv("../data/real/ASAP-PBMC/meta_c4.csv", row.names = 1)
