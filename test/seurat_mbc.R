...
result_path <- "mbc/seurat/"
# # For Spleen dataset, uncomment the lines below
...
write.table(coembed@reductions$pca@cell.embeddings[(dim(seurat.rna)[2]+1):(dim(seurat.atac)[2] + dim(seurat.rna)[2]), ], file = paste0(result_path, "seurat_pca_c2.txt"), sep = "\t")
write.table(coembed@reductions$umap@cell.embeddings[1:dim(seurat.rna)[2], ], file = paste0(result_path, "seurat_umap_c1.txt"), sep = "\t")
write.table(coembed@reductions$umap@cell.embeddings[(dim(seurat.rna)[2]+1):(dim(seurat.atac)[2] + dim(seurat.rna)[2]), ], file = paste0(result_path, "seurat_umap_c2.txt"), sep = "\t")
