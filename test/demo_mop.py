...
# In[]
dir = "../data/real/MOp_ext/"
# result_dir = "MOp/cfrm/"
result_dir = "MOp/cfrm_pseudo_ext/"
# result_dir = "MOp/cfrm_bins/"
...
utils.plot_latent_ext(x_umaps, annos = labels_trans, mode = "separate", save = result_dir + f'latent_separate_{K}_{T}_trans.png', figsize = (15,25), axis_label = "UMAP", markerscale = 6, s = 5, label_inplace = True)

utils.plot_latent_ext(x_umaps, annos = labels_remap, mode = "separate", save = result_dir + f'latent_separate_{K}_{T}.png', figsize = (15,25), axis_label = "UMAP", markerscale = 6, s = 5, label_inplace = True)
...
utils.plot_latent_ext(x_umaps, annos = labels_trans, mode = "separate", save = result_dir + f'latent_separate_{K}_{T}_trans_processed2.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = False, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(x_umaps, annos = labels_remap, mode = "separate", save = result_dir + f'latent_separate_{K}_{T}_processed2.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = False, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(x_umaps, annos = labels_remap, mode = "modality", save = result_dir + f'latent_batches_{K}_{T}_processed2.png', 
                      figsize = (10,7), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = False, alpha = 0.7)
...
# In[] Baseline methods
# UINMF
# uinmf_path = "MOp/uinmf/"
uinmf_path = "MOp/uinmf_bin/" 
...
liger_umap = UMAP(n_components = 2, min_dist = 0.4, random_state = 0).fit_transform(np.concatenate((H1, H2, H3), axis = 0))
liger_umaps = []
for batch in range(n_batches):
    if batch == 0:
        start_pointer = 0
...
utils.plot_latent_ext(liger_umaps, annos = labels_trans, mode = "separate", save = uinmf_path + f'latent_separate_uinmf_trans.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(liger_umaps, annos = labels_remap, mode = "separate", save = uinmf_path + f'latent_separate_uinmf.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(liger_umaps, annos = labels_remap, mode = "modality", save = uinmf_path + f'latent_batches_uinmf.png', 
                      figsize = (10,7), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7)


# Multimap
multimap_path = "MOp/multimap/"
batches = pd.read_csv(multimap_path + "batch_id.csv", index_col = 0)
X_multimap = np.load(multimap_path + "multimap.npy")
G_multimap = sp.load_npz(multimap_path + "multimap_graph.npz")
X_multimaps = []
for batch in ["C1", "C2", "C3"]:
    X_multimaps.append(X_multimap[batches.values.squeeze() == batch, :])


utils.plot_latent_ext(X_multimaps, annos = labels_trans, mode = "separate", save = multimap_path + f'latent_separate_multimap_trans.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(X_multimaps, annos = labels_remap, mode = "separate", save = multimap_path + f'latent_separate_multimap.png', 
                      figsize = (10,15), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7, text_size = "x-large")

utils.plot_latent_ext(X_multimaps, annos = labels_remap, mode = "modality", save = multimap_path + f'latent_batches_multimap.png', 
                      figsize = (10,7), axis_label = "Latent", markerscale = 6, s = 5, label_inplace = True, alpha = 0.7)
...
fig = utils.plot_factor(C_gene, markers = genes, cluster = 0, figsize = (10,10))
fig.savefig(sub_dir + "marker_genes.png")

sub_dir = result_dir + "L6IT/"
if not os.path.exists(sub_dir):
    os.makedirs(sub_dir)
fig = utils.plot_factor(C_gene, markers = genes, cluster = 6, figsize = (10,10))
fig.savefig(sub_dir + "marker_genes.png")
...
fig = utils.plot_factor(C_gene, markers = genes, cluster = 8, figsize = (10,10))
fig.savefig(sub_dir + "marker_genes.png")
...
fig = utils.plot_factor(C_gene, markers = genes, cluster = [2,4,5,7], figsize = (10,12))
fig.savefig(sub_dir + "marker_genes.png")
...
fig = utils.plot_factor(C_gene, markers = genes, cluster = 10, figsize = (10,25))
fig.savefig(sub_dir + "marker_genes.png")
