...
result_path <- "simulated/6b16c_test_10/protein_scenario2/stabmap/"
...
counts.protein.1 <- as.matrix(read.table(paste0(path, 'PxC1.txt'), sep = "\t"))
counts.protein.2 <- as.matrix(read.table(paste0(path, 'PxC2.txt'), sep = "\t"))
counts.protein.3 <- as.matrix(read.table(paste0(path, 'PxC3.txt'), sep = "\t"))
counts.protein.4 <- as.matrix(read.table(paste0(path, 'PxC4.txt'), sep = "\t"))
counts.protein.5 <- as.matrix(read.table(paste0(path, 'PxC5.txt'), sep = "\t"))
counts.protein.6 <- as.matrix(read.table(paste0(path, 'PxC6.txt'), sep = "\t"))
...
protein2gene <- as.matrix(read.table(paste0(path, "protein2gene.txt"), sep = "\t"))
...
result_path <- "simulated/6b16c_test_10/protein_scenario1/stabmap/"
dir.create(result_path, showWarnings = FALSE)
