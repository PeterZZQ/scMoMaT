...
write.csv(H.norm0, paste0(result_path, "H0_norm.csv"))
write.csv(H.norm1, paste0(result_path, "H1_norm.csv"))
write.csv(H.norm2, paste0(result_path, "H2_norm.csv"))
write.csv(H.norm3, paste0(result_path, "H3_norm.csv"))
write.csv(H.norm4, paste0(result_path, "H4_norm.csv"))
write.csv(H.norm5, paste0(result_path, "H5_norm.csv"))
write.csv(H.norm6, paste0(result_path, "H6_norm.csv"))
write.csv(H.norm7, paste0(result_path, "H7_norm.csv"))
