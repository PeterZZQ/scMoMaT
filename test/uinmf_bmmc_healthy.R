...
counts.bin <- readMM(paste0(path, 'BxC1.mtx'))
...
result_path <- "bmmc_healthyhema_2000/liger/"
...
#
################################################
result_path <- "bmmc_healthyhema_1000/uinmf/"
...
#
################################################
result_path <- "bmmc_healthyhema_1000/uinmf_bin/"
# result_path <- "bmmc_healthyhema_2000/uinmf_bin/"
