...
for path in paths:
    ...
    for i, alpha in enumerate(alphas):
        ...
        for run in range(runs):
            ...
            np.save("./results_multi/hori/" + path[:-1] + "_" + str(i) + "_" + str(run) + "_C0.npy", model1.Cs[0].cpu().detach().numpy())
            np.save("./results_multi/hori/" + path[:-1] + "_" + str(i) + "_" + str(run) + "_C1.npy", model1.Cs[1].cpu().detach().numpy())
            ...
            utils.plot_latent(z[:z_b1.shape[0],:], z[z_b1.shape[0]:,:], label_b1, label_b2, mode= "separate", save = "./results_multi/hori/plots/" + path[:-1] + "_" + str(run) + "_" + str(i) + "_cfrm.png")
            
            utils.plot_latent(z[:z_b1.shape[0],:], z[z_b1.shape[0]:,:], max_b1, max_b2, mode= "separate", save = "./results_multi/hori/plots/predict_" + path[:-1] + "_" + str(run) + "_" + str(i) + "_cfrm.png")
...
#             g.savefig("./results/plots/clustmap_atac_" + path[:-1] + "_" + str(run) + "_" + str(i) + "_cfrm.png")
        ...
        np.save( "./results_multi/hori/" + path[:-1] + "_" + str(i) + "_ari_cfrm.npy", np.array(ari_cfrm))  
        np.save( "./results_multi/hori/" + path[:-1] + "_" + str(i) + "_losses.npy", np.array(losses))
