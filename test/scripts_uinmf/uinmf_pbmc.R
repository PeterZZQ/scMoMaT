...
counts.atac.3 <- readMM(paste0(data_dir, 'RxC3.mtx'))
counts.atac.4 <- readMM(paste0(data_dir, 'RxC4.mtx'))
counts.bin.3 <- readMM(paste0(data_dir, 'BxC3.mtx'))
counts.bin.4 <- readMM(paste0(data_dir, 'BxC4.mtx'))
counts.protein.1 <- readMM(paste0(data_dir, 'PxC1.mtx'))
counts.protein.2 <- readMM(paste0(data_dir, 'PxC2.mtx'))
counts.protein.3 <- readMM(paste0(data_dir, 'PxC3.mtx'))
counts.protein.4 <- readMM(paste0(data_dir, 'PxC4.mtx'))
genes <- read.csv(paste0(data_dir, "genes.txt"), header = F)[[1]]
regions <- read.csv(paste0(data_dir, "regions.txt"), header = F)[[1]]
proteins <- read.csv(paste0(data_dir, "proteins.txt"), header = F)[[1]]
