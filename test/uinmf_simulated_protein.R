...
counts.rna.3 <- as.matrix(read.table(paste0(dir, 'GxC3.txt'), sep = "\t"))
counts.rna.4 <- as.matrix(read.table(paste0(dir, 'GxC4.txt'), sep = "\t"))
counts.rna.5 <- as.matrix(read.table(paste0(dir, 'GxC5.txt'), sep = "\t"))
counts.rna.6 <- as.matrix(read.table(paste0(dir, 'GxC6.txt'), sep = "\t"))

counts.atac.1 <- as.matrix(read.table(paste0(dir, 'RxC1.txt'), sep = "\t"))
counts.atac.2 <- as.matrix(read.table(paste0(dir, 'RxC2.txt'), sep = "\t"))
counts.atac.3 <- as.matrix(read.table(paste0(dir, 'RxC3.txt'), sep = "\t"))
counts.atac.4 <- as.matrix(read.table(paste0(dir, 'RxC4.txt'), sep = "\t"))
counts.atac.5 <- as.matrix(read.table(paste0(dir, 'RxC5.txt'), sep = "\t"))
counts.atac.6 <- as.matrix(read.table(paste0(dir, 'RxC6.txt'), sep = "\t"))

counts.protein.1 <- as.matrix(read.table(paste0(dir, 'PxC1.txt'), sep = "\t"))
counts.protein.2 <- as.matrix(read.table(paste0(dir, 'PxC2.txt'), sep = "\t"))
counts.protein.3 <- as.matrix(read.table(paste0(dir, 'PxC3.txt'), sep = "\t"))
counts.protein.4 <- as.matrix(read.table(paste0(dir, 'PxC4.txt'), sep = "\t"))
counts.protein.5 <- as.matrix(read.table(paste0(dir, 'PxC5.txt'), sep = "\t"))
counts.protein.6 <- as.matrix(read.table(paste0(dir, 'PxC6.txt'), sep = "\t"))

genes <- paste("gene_", seq(1, 1000), sep = "")
regions <- paste("region_", seq(1, 3000), sep = "")
proteins <- paste("protein_", seq(1, 200), sep = "")

meta.cell.1 <- read.csv(paste0(dir, "cell_label1.txt"), header = T, sep = "\t", row.names = 1)
meta.cell.2 <- read.csv(paste0(dir, "cell_label2.txt"), header = T, sep = "\t", row.names = 1)
meta.cell.3 <- read.csv(paste0(dir, "cell_label3.txt"), header = T, sep = "\t", row.names = 1)
meta.cell.4 <- read.csv(paste0(dir, "cell_label4.txt"), header = T, sep = "\t", row.names = 1)
meta.cell.5 <- read.csv(paste0(dir, "cell_label5.txt"), header = T, sep = "\t", row.names = 1)
meta.cell.6 <- read.csv(paste0(dir, "cell_label6.txt"), header = T, sep = "\t", row.names = 1)
...
gene2region <- t(as.matrix(read.table(paste0(dir, "region2gene.txt"), sep = "\t")))
protein2gene <- as.matrix(read.table(paste0(dir, "protein2gene.txt"), sep = "\t"))
