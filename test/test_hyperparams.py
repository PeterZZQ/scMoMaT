...
sns.barplot(data = scores, x = "K", hue = "lamb", y = "NMI",  ax = ax[0], capsize = 0.1)
sns.barplot(data = scores, x = "K", hue = "lamb", y = "ARI",  ax = ax[1], capsize = 0.1)
sns.barplot(data = scores, x = "K", hue = "lamb", y = "GC",  ax = ax[2], capsize = 0.1)
...
fig = plt.figure(figsize = (20, 5))
ax = fig.subplots(nrows = 1, ncols = 3)
sns.barplot(data = scores, x = "n_neighbor", hue = "r", y = "NMI",  ax = ax[0], capsize = 0.1)
sns.barplot(data = scores, x = "n_neighbor", hue = "r", y = "ARI",  ax = ax[1], capsize = 0.1)
sns.barplot(data = scores, x = "n_neighbor", hue = "r", y = "GC",  ax = ax[2], capsize = 0.1)
ax[0].get_legend().remove()
ax[1].get_legend().remove()
# ax[0].legend(loc='upper left', prop={'size': 15}, frameon = False, ncol = 1, bbox_to_anchor=(1.04, 1))
# ax[1].legend(loc='upper left', prop={'size': 15}, frameon = False, ncol = 1, bbox_to_anchor=(1.04, 1))
