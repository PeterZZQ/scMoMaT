...
# ALS running very slow on large matrix, with longer time can converge to good result. Deprecated
        ...
        for t in range(T):
            ...
            for i, mod in enumerate(self.mods):
                ...
                for iter in range(100):
                    ...
                    # stopping criteria
                    if grad_val < tol:
                        print("grad_val = " + str(grad_val.item()))
                        print("C_cells_" + mod + ", iter: " + str(iter))
                        break
            ...
            for i, mod in enumerate(self.mods):
                for iter in range(100):
                    ...
                    if grad_val < tol:
                        print("grad_val = " + str(grad_val.item()))
                        print("C_feats_" + mod + ", iter: " + str(iter))
                        break
            ...
            for i, mod in enumerate(self.mods):
                ...
                for iter in range(100):
                    ...
                    if grad_val < tol:
                        print("grad_val = {:.5e}".format(grad_val.item()))
                        print("A_assos_" + mod + ", iter: " + str(iter))
                        break                    
            self.A_assos[-1].requires_grad = False
            with torch.no_grad():
                for i, mod in enumerate(self.mods):
