...
#         self.b_2 = torch.zeros(self.R.shape[0],1).to(device)
    ...
    def batch_loss(self, mode='C_c'):
        ...
        if mode == 'C_12':
            loss1 = (self.G[np.ix_(mask_1, mask_g)] - (self.softmax(self.C_1[mask_1,:]) @ self.act(self.Ag.detach()) @ self.softmax(self.C_g[mask_g, :].detach()).t()) - self.b_g[:, mask_g] - self.b_1[mask_1,:]).pow(2).mean()
            ...
            loss3 = 0
            loss4 = 0 
            loss5 = self.entropy_loss(self.C_1[mask_1,:]) + self.entropy_loss(self.C_2[mask_2,:]) + self.entropy_loss(self.C_g[mask_g,:].detach()) + self.entropy_loss(self.C_r[mask_r,:].detach()) # + self.b_1[mask_1,:].pow(2).mean() + self.b_2[mask_2,:].pow(2).mean() + self.b_g[:,mask_g].pow(2).mean() + self.b_r[:,mask_r].pow(2).mean()
                
        elif mode == 'C_gr':
            loss1 = (self.G[np.ix_(mask_1, mask_g)] - (self.softmax(self.C_1[mask_1,:].detach()) @ self.act(self.Ag.detach()) @ self.softmax(self.C_g[mask_g, :]).t()) - self.b_g[:, mask_g] - self.b_1[mask_1,:]).pow(2).mean()
...
#             loss3 = (self.A[np.ix_(mask_g, mask_r)].t() @ self.softmax(self.C_g[mask_g,:]) - self.softmax(self.C_r[mask_r,:])).pow(2).mean()
            ...
            loss4 = 0 
            loss5 = self.entropy_loss(self.C_1[mask_1,:].detach()) + self.entropy_loss(self.C_2[mask_2,:].detach()) + self.entropy_loss(self.C_g[mask_g,:]) + self.entropy_loss(self.C_r[mask_r,:]) # + self.b_1[mask_1,:].pow(2).mean() + self.b_2[mask_2,:].pow(2).mean() + self.b_g[:,mask_g].pow(2).mean() + self.b_r[:,mask_r].pow(2).mean() 
            
        
        elif mode == "A":
            loss1 = (self.G[np.ix_(mask_1, mask_g)] - (self.softmax(self.C_1[mask_1,:].detach()) @ self.act(self.Ag) @ self.softmax(self.C_g[mask_g, :].detach()).t()) - self.b_g[:, mask_g] - self.b_1[mask_1,:]).pow(2).mean()
            ...
            with torch.no_grad():
                loss1 = (self.G - (self.softmax(self.C_1) @ self.act(self.Ag) @ self.softmax(self.C_g).t()) - self.b_g - self.b_1).pow(2).mean()
...
#                 loss3 = (self.A.t() @ self.softmax(self.C_g) - self.softmax(self.C_r)).pow(2).mean()
                ...
                # loss4 = - torch.trace((self.Ar/torch.norm(self.Ar)).t() @ (self.Ag)/torch.norm(self.Ag))
                loss4 = (self.Ar - self.Ag).pow(2).mean()
                loss5 = self.entropy_loss(self.C_1) + self.entropy_loss(self.C_2) + self.entropy_loss(self.C_g) + self.entropy_loss(self.C_r) #+ self.b_1.pow(2).mean() + self.b_2.pow(2).mean() + self.b_g.pow(2).mean() + self.b_r.pow(2).mean() 
